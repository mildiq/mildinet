...
from application.interfaces.dm import ICommentDm
...
class InfraProvider(Provider):
    ...
    @provide(scope=Scope.REQUEST)
    def comments(self, *, transaction: TransactionManager) -> ICommentDm:
        return CommentDm(_tm=transaction)

    @provide(scope=Scope.REQUEST)
    def post_likes(self, *, transaction: TransactionManager) -> IPostLikeDm:
        return PostLikeDm(_tm=transaction)

    @provide(scope=Scope.REQUEST)
    def comments_likes(self, *, transaction: TransactionManager) -> ICommentLikeDm:
        return CommentLikeDm(_tm=transaction)
    ...
    @provide(scope=Scope.REQUEST)
    def media(self, *, transaction: TransactionManager) -> IMediaDm:
        return MediaDm(_tm=transaction)

    @provide(scope=Scope.REQUEST)
    def stored_objects(self, *, transaction: TransactionManager) -> IStoredObjectDm:
        return StoredObjectDm(_tm=transaction)
